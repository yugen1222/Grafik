...
// V13: online presence indicator. Core data is loaded only from Realtime Database.
window.firebaseConnectedV13 = false;
window.db.ref('.info/connected').on('value', snap => {
  window.firebaseConnectedV13 = snap.val() === true;
});
